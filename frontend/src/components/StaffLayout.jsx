...
export function StaffLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900">
      {/* Desktop Sidebar */}
      <div className="hidden lg:block fixed left-0 top-0 h-screen w-72 bg-gradient-to-b from-slate-900 to-slate-950 shadow-2xl border-r border-slate-800 z-30 overflow-y-auto">
        <StaffSidebar />
      </div>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 border-b border-slate-800 bg-slate-950/95 backdrop-blur-md px-4 py-3 flex items-center justify-between">
        <h1 className="text-white font-semibold">Staff Panel</h1>
        <button
      ...
      <main className="w-full overflow-y-auto min-h-screen lg:ml-72 pt-16 lg:pt-0">
